const proyectos = [
    {nombre: 'Poyecto Final Javascript en Casa del Futuro', descripcion: 'Proyecto Final Consumiendo API de peliculas con JS y Local Storage. Para Curso de Desarrollador Javascript.', link:''},
   ...
   const data = proyectos.map( proyecto => {
        ...
        <div class="book">
            ...
            <button class="moreInfobtn">
                <a class="link__proyect" href="#" target="_blank">Ver</a>
            </button>
            <div class="cover">
